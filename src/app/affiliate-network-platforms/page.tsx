...
const page = seoLandingPageMap["affiliate-network-platforms"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/affiliate-network-platforms",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/affiliate-network-platforms",
    type: "article",
  },
};
