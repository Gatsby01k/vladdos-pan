...
const page = seoLandingPageMap["performance-marketing-affiliates"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/performance-marketing-affiliates",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/performance-marketing-affiliates",
    type: "article",
  },
};
