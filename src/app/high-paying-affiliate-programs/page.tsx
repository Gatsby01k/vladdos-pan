...
const page = seoLandingPageMap["high-paying-affiliate-programs"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/high-paying-affiliate-programs",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/high-paying-affiliate-programs",
    type: "article",
  },
};
