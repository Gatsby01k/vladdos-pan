...
const page = seoLandingPageMap["high-converting-affiliate-offers"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/high-converting-affiliate-offers",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/high-converting-affiliate-offers",
    type: "article",
  },
};
