...
const page = seoLandingPageMap["igaming-marketing-strategies"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/igaming-marketing-strategies",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/igaming-marketing-strategies",
    type: "article",
  },
};
