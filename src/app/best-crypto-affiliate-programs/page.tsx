...
const page = seoLandingPageMap["best-crypto-affiliate-programs"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/best-crypto-affiliate-programs",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/best-crypto-affiliate-programs",
    type: "article",
  },
};
