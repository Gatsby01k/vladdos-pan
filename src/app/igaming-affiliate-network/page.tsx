...
const page = seoLandingPageMap["igaming-affiliate-network"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/igaming-affiliate-network",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/igaming-affiliate-network",
    type: "article",
  },
};
