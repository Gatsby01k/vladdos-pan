...
const page = seoLandingPageMap["private-affiliate-network"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/private-affiliate-network",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/private-affiliate-network",
    type: "article",
  },
};
