...
const page = seoLandingPageMap["casino-affiliate-traffic"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/casino-affiliate-traffic",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/casino-affiliate-traffic",
    type: "article",
  },
};
