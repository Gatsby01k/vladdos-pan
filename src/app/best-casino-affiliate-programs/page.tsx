...
const page = seoLandingPageMap["best-casino-affiliate-programs"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/best-casino-affiliate-programs",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/best-casino-affiliate-programs",
    type: "article",
  },
};
