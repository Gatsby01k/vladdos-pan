...
const page = seoLandingPageMap["affiliate-marketing-igaming"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/affiliate-marketing-igaming",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/affiliate-marketing-igaming",
    type: "article",
  },
};
