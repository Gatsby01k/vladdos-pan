...
const page = seoLandingPageMap["crypto-gambling-affiliate"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/crypto-gambling-affiliate",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/crypto-gambling-affiliate",
    type: "article",
  },
};
