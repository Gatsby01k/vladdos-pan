...
const page = seoLandingPageMap["affiliate-network-directory"];

export const metadata: Metadata = {
  title: page.metadataTitle,
  description: page.metadataDescription,
  alternates: {
    canonical: "https://vladdos.com/affiliate-network-directory",
  },
  openGraph: {
    title: `${page.metadataTitle} | VlaDDoS PAN`,
    description: page.metadataDescription,
    url: "https://vladdos.com/affiliate-network-directory",
    type: "article",
  },
};
